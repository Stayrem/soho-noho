...
function placesTrigger(element){
	console.log(element);
	var req = element.getAttribute('rel');
	var request = {
...
function initItemMap() {
    ...
    if (document.querySelector('.custom-map') != null) {
        var lat = 55.752111;
        var lang = 37.591961;
        var zoom = 14;
        var markerImage = 'https://thebook.nikaestate.ru/wp-content/uploads/2019/06/marker-2.png';
		
		var center = new google.maps.LatLng(lat, lang);
		
	map = new google.maps.Map(document.querySelector('.custom-map'),{
		center: center,
		zoom: zoom
	});
		...
		var btnContainer = document.querySelector('.custom-map-btn');
		if(btnContainer != null){
			var btnItems = btnContainer.querySelectorAll('.custom-map-filter-btn');
			for ( var i = 0; i < btnItems.length; i++ ){

				btnItems[i].addEventListener('click', function() {
					var req = this.getAttribute('data-place-type');
					var request = {
						location: center,
						radius: 5000,
						types: [req]
